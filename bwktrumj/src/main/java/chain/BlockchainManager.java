...
import org.sendj.core.CheckpointManager;
...
import org.sendj.core.TransactionBroadcast;
...
import org.sendj.net.discovery.MultiplexingDiscovery;
import org.sendj.net.discovery.PeerDiscovery;
import org.sendj.net.discovery.PeerDiscoveryException;
import org.sendj.params.MainNetParams;
import org.sendj.params.RegTestParams;
import org.sendj.params.TestNet3Params;
import org.sendj.store.BlockStore;
import org.sendj.store.BlockStoreException;
import org.sendj.store.LevelDBBlockStore;
import org.sendj.store.SPVBlockStore;
                        ...
                        public InetSocketAddress[] getPeers(final long services, final long timeoutValue, final TimeUnit timeoutUnit)
                            ...
                            if (hasTrustedPeer) {
                                ...
                                if (trustedPeerHost.equals(KAALI_TESTNET_SERVER) && !conf.isTest()){
                                    addr = new InetSocketAddress(trustedPeerHost, 24433);
                                }else {
