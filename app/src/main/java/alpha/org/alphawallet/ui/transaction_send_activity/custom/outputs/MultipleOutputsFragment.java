package alpha.org.alphawallet.ui.transaction_send_activity.custom.outputs;
...
public class MultipleOutputsFragment extends BaseRecyclerFragment<OutputWrapper> {
        ...
        adapter = new BaseRecyclerAdapter<OutputWrapper, OutputHolder>(getActivity()) {
            ...
            protected void bindHolder(final OutputHolder holder, final OutputWrapper data, final int position) {
                ...
                if (data.getAddress()!=null){
                    ...
                    if (!alphaModule.chechAddress(data.getAddress())) {
                        ...
                        if (s.length()>0){
                            if (holder.edit_address!=null) {
                                ...
                                if (!alphaModule.chechAddress(address)) {
                                    ...
                                    AddressLabel addressLabel = alphaModule.getAddressLabel(address);
    ...
    public void addOutput(){
        ...
        if (address==null || !alphaModule.chechAddress(address)){
            // todo: mejorar esto
    ...
    public List<OutputWrapper> getList() throws InvalidFieldException {
        ...
        for (int i=0;i<list.size();i++){
            ...
            boolean checkAddress = address==null || !alphaModule.chechAddress(address);
