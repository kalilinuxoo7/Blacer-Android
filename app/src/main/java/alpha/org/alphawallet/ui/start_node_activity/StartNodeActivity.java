package alpha.org.alphawallet.ui.start_node_activity;
...
import alpha.org.alphawallet.ui.pincode_activity.PincodeActivity;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = alphaApplication.getAppConf().getTrustedNode()!=null;
                alphaApplication.setTrustedServer(selectedNode);
        ...
        BwktrumPeerData bwktrumPeer = alphaApplication.getAppConf().getTrustedNode();
