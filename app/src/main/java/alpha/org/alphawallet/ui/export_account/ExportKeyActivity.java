package alpha.org.alphawallet.ui.export_account;
...
import alpha.org.alphawallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = alphaModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(AlphaContext.NETWORK_PARAMETERS);
