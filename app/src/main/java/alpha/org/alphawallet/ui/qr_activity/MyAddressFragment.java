...
import static alpha.org.alphawallet.utils.AndroidUtils.copyToClipboard;
import static alpha.org.alphawallet.utils.QrUtils.encodeAsBitmap;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(AlphaModule alphaModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(alphaModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = AlphaApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String alphaUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(alphaUri,address.toBase58());
            }
    ...
    public void setModule(AlphaModule module) {
        this.module = module;
    }
