package alpha.org.alphawallet.ui.settings_activity;
...
import alpha.org.alphawallet.BuildConfig;
...
import alpha.org.alphawallet.ui.export_account.ExportKeyActivity;
import alpha.org.alphawallet.ui.import_watch_only.SettingsWatchOnly;
import alpha.org.alphawallet.ui.restore_activity.RestoreActivity;
import alpha.org.alphawallet.ui.settings_backup_activity.SettingsBackupActivity;
import alpha.org.alphawallet.ui.settings_network_activity.SettingsNetworkActivity;
import alpha.org.alphawallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import alpha.org.alphawallet.ui.start_node_activity.StartNodeActivity;
import alpha.org.alphawallet.ui.tutorial_activity.TutorialActivity;
import alpha.org.alphawallet.utils.CrashReporter;
import alpha.org.alphawallet.utils.DialogsUtil;
import alpha.org.alphawallet.utils.IntentsUtils;
import alpha.org.alphawallet.utils.NavigationUtils;
import alpha.org.alphawallet.utils.ReportIssueDialogBuilder;
...
import static alpha.org.alphawallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#0098FF>Pablo-Dev & Kaali</font> <br>(c) BlacerCoin Community";
    ...
    private void updateNetworkStatus() {
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#0098FF>"+alphaModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#0098FF>"+alphaModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#0098FF>"+
                                alphaModule.getProtocolVersion()+"</font>"
        ...
        SimpleTwoButtonsDialog dialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                ...
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        alphaApplication.stopBlockchain();
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "alpha.org.alphawallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return AlphaContext.REPORT_SUBJECT_ISSUE+" "+alphaApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, alphaApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return alphaModule.getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }
