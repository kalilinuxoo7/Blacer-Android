package alpha.org.alphawallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = alphaModule.backupWallet(backupFile, firstPassword);

            if (result){
                alphaApplication.getAppConf().setHasBackup(true);
