...
public class AlphaContext {
    ...
    /** Alpha wallet released time */
    public static final long ALPHA_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1500940800;
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "alpha-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
