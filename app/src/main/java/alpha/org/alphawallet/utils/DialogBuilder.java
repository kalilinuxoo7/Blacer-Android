...
public class DialogBuilder extends AlertDialog.Builder
{
	...
	{
		setNeutralButton("Dismiss", dismissListener);

		return this;
	}

	public DialogBuilder twoButtons(final OnClickListener leftClickListener,final OnClickListener rightClickListener) {
		setNegativeButton("No", leftClickListener);
