...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final AlphaApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (AlphaContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + AlphaContext.NETWORK_PARAMETERS.getId() + "\n");
